  ...
  return (
    <header className="w-full p-4  px-5 sm:px-10 flex items-center justify-between">
        ...
        >
            ...
            <Link href="/personnel" className="mx-2">Personnel</Link>
        ...
        <div className=" hidden sm:flex items-center">
            <a href={siteMetadata.twitter} className="inline-block w-6 h-6 mr-4" target="_blank" aria-label="Check out our work via Twitter"><TwitterIcon className="hover:scale-125 transition-all ease duration-200" /></a>
            <a href={siteMetadata.github} className="inline-block w-6 h-6 mr-4" target="_blank" aria-label="Get the code for our visualization and publications on Github"><GithubIcon className="  hover:scale-125 transition-all ease duration-200 dark:fill-light" /></a>
        </div>
    </header>
  )
}
